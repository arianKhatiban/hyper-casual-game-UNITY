...
namespace CnControls
{
    ...
    public class JoystickInputHelper : BaseInputHelper
    {
        ...
        private RectTransform _joystickTouchRect;
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < CnInputManager.TouchCount; i++)
            {
                ...
                if (RectTransformUtility.RectangleContainsScreenPoint(_joystickTouchRect, touch.position, UiRootCamera))
                {
            ...
            if (RectTransformUtility.RectangleContainsScreenPoint(_joystickTouchRect,
